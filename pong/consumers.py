...
from .consts import CANVAS_WIDTH, CANVAS_HEIGHT, PADDLE_WIDTH, PADDLE_THICKNESS, PADDING, BALL_SIZE
...
class PongConsumer(AsyncWebsocketConsumer):
    scheduled_task = None
    right_paddle = Paddle(CANVAS_WIDTH - PADDLE_WIDTH - PADDING, (CANVAS_HEIGHT - PADDLE_THICKNESS) / 2, \
                          PADDLE_THICKNESS, PADDLE_WIDTH)
    left_paddle = Paddle(PADDING, (CANVAS_HEIGHT - PADDLE_THICKNESS) / 2, PADDLE_THICKNESS, PADDLE_WIDTH)
...
#     scheduled_task = None
#     right_paddle = Paddle(CANVAS_WIDTH - PADDLE_WIDTH - PADDING, (CANVAS_HEIGHT - PADDLE_THICKNESS) / 2, PADDLE_THICKNESS, PADDLE_WIDTH)
#     left_paddle = Paddle(PADDING, (CANVAS_HEIGHT - PADDLE_THICKNESS) / 2, PADDLE_THICKNESS, PADDLE_WIDTH)
#     ball = Ball(CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2, BALL_SIZE)
#     ready = False
#     game_continue = False
